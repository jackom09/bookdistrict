...
urlpatterns = [
    ...
    path('books/<int:pk>/add_comment/', views.CommentCreate.as_view(), name='comment_create'),
    path('books/<int:pk>/comment/<int:comment_pk>/delete/', views.CommentDelete.as_view(), name='comment_delete'),
